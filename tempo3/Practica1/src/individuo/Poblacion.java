...
public class Poblacion {
	...
	int[] cruceOx_aux(Individuo padre,Individuo hijo, int pCorte1, int pCorte2,int r_aux, int rellenados_aux, int lcrom)
	{
	...
	private Individuo[] cruceOx (Individuo padre1, Individuo padre2, int punto_cruce, Object x_min, Object x_max) {
		...
		*/		
		...
		int [] res=this.cruceOx_aux(padre1, hijo1, pCorte1, pCorte2, pCorte2, rellenados, lcrom);
		//actualizo indices
		rellenados=res[0];
		r=res[1];
		
		//relleno hijo1 con elementos de padre2 
		res=this.cruceOx_aux(padre2, hijo1, pCorte1, pCorte2, r, rellenados, lcrom);
		//actualizo indices
		rellenados=res[0];
		r=res[1];
		
		//relleno hijo2 con elementos de padre2
		res=this.cruceOx_aux(padre2, hijo2, pCorte1, pCorte2, pCorte2, rellenados, lcrom);
		//actualizo indices
		rellenados=res[0];
		r=res[1];
		
		//relleno hijo2 con elementos de padre1 
		res=this.cruceOx_aux(padre1, hijo2, pCorte1, pCorte2, r, rellenados, lcrom);
		//actualizo indices
		rellenados=res[0];
		r=res[1];
