...
public class AGenetico {
	 ...
	 * ARGUMENTOS argf2
	 * argf2 [0] = SEMILLA
	 * argf2 [1] = TIPOMUTACION
	 */
	public AGenetico (int argf1,Object argf2,int tipoAlgoritmo, individuo.Individuo prototipo, int tam_pob, double prec, double prob_cruce, double prob_mut, Object x_min, Object x_max, int num_max_gen, boolean elitismo, int tSeleccion, int tCruce) {
		...
		for (int i=0;i<num_max_gen;i++) {
			...
			this.pob.reproduccion(prob_cruce, x_min, x_max, 2);
