...
public class Funcion4 {
	...
	private final Double[] x_min = {Double.valueOf(0)};
	private final Double[] x_max = {Double.valueOf(Math.PI)};
	...
	public Funcion4 (double prec, int tam_pob, int num_iter, double pCruces, double pMut, int tCruce, int tSeleccion, boolean elitismo) {
		this.prec = prec;
		...
		this.unAlgoritmo = new AGenetico
			(0, new individuo.Individuo_basico(), this.tam_pob, this.prec, this.pCruces, this.pMut, this.x_min, this.x_max, this.num_iter, elitismo, this.tSeleccion, this.tCruce);
	}
