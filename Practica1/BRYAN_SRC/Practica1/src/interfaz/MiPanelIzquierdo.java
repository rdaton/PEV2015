...
public class MiPanelIzquierdo extends JPanel {
	...
	protected JButton buttonEliminar;
	...
	public MiPanelIzquierdo() {
		...
		buttonEliminar = new JButton("Limpiar este AG");
		buttonEliminar.setPreferredSize(new Dimension (180, 60));
		buttonEliminar.setEnabled(true);
		buttonEliminar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				textPrecision.setText("");
				textPrecision.setText("");
				textPoblacion.setText("");
				textIteraciones.setText("");
				textProCruces.setText("");
				textProMutacion.setText("");
	...
	public JPanel invocarFuncion() {
		...
		switch (selec) {
		case 0:
			Funcion1 unaFuncion1 = new Funcion1(prec, tam_pob, num_iter, pCruces, pMut, tCruce, tSeleccion, elitismo);
			elPeor = unaFuncion1.getMejorEntrePeores();
			resultados = unaFuncion1.dameResultados();
			break;
		case 1:
			Funcion2 unaFuncion2 = new Funcion2(prec, tam_pob, num_iter, pCruces, pMut, tCruce, tSeleccion, elitismo);
			elMejor = unaFuncion2.getMejorEntreMejores();
			resultados = unaFuncion2.dameResultados();
			break;
		case 2:
			Funcion3 unaFuncion3 = new Funcion3(prec, tam_pob, num_iter, pCruces, pMut, tCruce, tSeleccion, elitismo);
			elMejor = unaFuncion3.getMejorEntreMejores();
			resultados = unaFuncion3.dameResultados();
			break;
		case 3:
			Funcion4 unaFuncion4 = new Funcion4(prec, tam_pob, num_iter, pCruces, pMut, tCruce, tSeleccion, elitismo);
			elMejor = unaFuncion4.getMejorEntrePeores();
			resultados = unaFuncion4.dameResultados();
			break;
		case 4:
			Funcion5 unaFuncion5 = new Funcion5(prec, tam_pob, num_iter, pCruces, pMut, tCruce, tSeleccion, elitismo);
			elMejor = unaFuncion5.getMejorEntreMejores();
