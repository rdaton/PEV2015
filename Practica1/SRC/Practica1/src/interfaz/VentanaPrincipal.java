...
public class VentanaPrincipal {
	...
	private void initialize() {
		...
		JLabel lblNewLabel_4 = new JLabel("Semilla");
		lblNewLabel_4.setBounds(12, 187, 70, 15);
		panel.add(lblNewLabel_4);

		JLabel lblSemilla = new JLabel("Selección");
		lblSemilla.setBounds(12, 243, 70, 15);
		...
		lblNewLabel_5.setBounds(12, 214, 70, 15);
