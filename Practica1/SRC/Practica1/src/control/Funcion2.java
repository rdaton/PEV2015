...
public class Funcion2 {
	...
	public Funcion2 (int argf1,int argf2,double prec,int tam_pob, int num_iter,double pCruces,double pMut,
		int tCruce,int tSeleccion,boolean elitismo)
	{
		 ...
		 unAlgoritmo=new AGenetico(argf1,argf2,1,new individuo.Individuo_f2(),tam_pob,prec,pCruces,pMut,x_min,x_max,num_iter,elitismo,tSeleccion,tCruce);
	}
