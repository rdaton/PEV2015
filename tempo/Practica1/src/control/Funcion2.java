...
public class Funcion2 {
	...
	public Funcion2(int argf1,int argf2,double prec, int tam_pob, int num_iter, double pCruces, double pMut, int tCruce, int tSeleccion, boolean elitismo) {
		this.prec = prec;
		...
		this.unAlgoritmo = new AGenetico
			 (argf1,argf2,1, new individuo.Individuo_f2(), this.tam_pob, this.prec, this.pCruces, this.pMut, this.x_min, this.x_max, this.num_iter, elitismo, this.tSeleccion, this.tCruce);
	}
