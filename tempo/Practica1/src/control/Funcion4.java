...
public class Funcion4 {
	...
	public Funcion4 (int argf1,int argf2,double prec, int tam_pob, int num_iter, double pCruces, double pMut, int tCruce, int tSeleccion, boolean elitismo) {
		...
		this.unAlgoritmo = new AGenetico
			(argf1,argf2,0, new individuo.Individuo_f4(), this.tam_pob, this.prec, this.pCruces, this.pMut, x_min, this.x_max, this.num_iter, elitismo, this.tSeleccion, this.tCruce);
	}
